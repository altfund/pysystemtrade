...
from pysystemtrade.systems.basesystem import ALL_KEYNAME
from pysystemtrade.systems.stage import SystemStage
from pysystemtrade.systems.defaults import system_defaults
from pysystemtrade.systems.system_cache import input, dont_cache, diagnostic, output

from pysystemtrade.syscore.genutils import str2Bool
from pysystemtrade.syscore.pdutils import apply_cap
from pysystemtrade.syscore.objects import resolve_function
...
class ForecastScaleCap(SystemStage):
    ...
    def get_raw_forecast(self, instrument_code, rule_variation_name):
        ...
        >>> from pysystemtrade.systems.tests.testdata import get_test_object_futures_with_rules
    ...
    def get_forecast_cap(self):
        ...
        We get the cap from:
                                 ...
                                 (c) or if missing: uses the forecast_cap from pysystemtrade.systems.default.py
        :returns: float
    ...
    def _get_forecast_scalar_fixed(self, instrument_code, rule_variation_name):
        ...
        We get the scalars from: (a) configuration file in parent system
                                 (b) or if missing: uses the scalar from pysystemtrade.systems.defaults.py
    ...
    def _get_forecast_scalar_estimated_from_instrument_list(
        ...
        # an example of a scaling function is pysystemtrade.syscore.algos.forecast_scalar
