...
from pysystemtrade.syscore.pdutils import fix_weights_vs_pdm
from pysystemtrade.syscore.objects import update_recalc, resolve_function
...
class _PortfoliosInputs(SystemStage):
    ...
    def get_subsystem_position(self, instrument_code):
        ...
        >>> from pysystemtrade.systems.tests.testdata import get_test_object_futures_with_pos_sizing
...
class _PortfoliosCalculateWeights(_PortfoliosInputs):
    ...
    def get_raw_estimated_instrument_weights(self):
        ...
        >>> from pysystemtrade.systems.tests.testdata import get_test_object_futures_with_pos_sizing_estimates
        >>> from pysystemtrade.systems.basesystem import System
