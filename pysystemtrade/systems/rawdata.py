...
class RawData(SystemStage):
    ...
    def daily_denominator_price(self, instrument_code):
        ...
        >>> from pysystemtrade.systems.tests.testdata import get_test_object
    ...
    def daily_returns_volatility(self, instrument_code):
        ...
        2015-12-11  0.058522
        >>>
        >>> config=Config(dict(volatility_calculation=dict(func="pysystemtrade.syscore.algos.robust_vol_calc", days=200)))
