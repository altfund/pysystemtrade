...
from pysystemtrade.syscore.objects import resolve_function, resolve_data_method, hasallattr
...
def create_variations_oneparameter(baseRule,
    ...
    >>>
    >>> rule=TradingRule(("pysystemtrade.systems.provided.example.rules.ewmac_forecast_with_defaults", [], {}))
