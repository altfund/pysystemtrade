...
from pysystemtrade.syscore.pdutils import fix_weights_vs_pdm, apply_cap, from_dict_of_values_to_df, dataframe_pad
from pysystemtrade.syscore.objects import resolve_function, update_recalc
...
class _ForecastCombinePreCalculate(SystemStage):
    ...
    def get_capped_forecast(self, instrument_code, rule_variation_name):
        ...
        >>> from pysystemtrade.systems.tests.testdata import get_test_object_futures_with_rules_and_capping
...
class _ForecastCombineCalculateDivMult(_ForecastCombinePreCalculate):
    ...
    def get_forecast_diversification_multiplier_estimated(self, instrument_code):
        ...
        # an example of an idm calculation function is pysystemtrade.syscore.divmultipliers.diversification_multiplier_from_list
