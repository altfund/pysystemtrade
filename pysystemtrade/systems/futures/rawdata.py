...
from pysystemtrade.syscore.dateutils import expiry_diff
from pysystemtrade.syscore.pdutils import uniquets
from pysystemtrade.systems.system_cache import input, diagnostic, output
...
class FuturesRawData(RawData):
    ...
    def get_instrument_raw_carry_data(self, instrument_code):
        ...
        >>> from pysystemtrade.systems.tests.testfuturesrawdata import get_test_object_futures
